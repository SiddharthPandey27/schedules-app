...
Schedule App shows a single dynamic page of all the cricket matches happening and a short status. The app has a number of filters to help the user to know the status of the present cricket matches.
