        ...
        <div className="measure bg-white pb3 pr3 pl3 mt0 mb3 pt1" id={matchSchedule.matchID}>
            <div className="pb2 pb4 pt1 pt2 w-100 bg-grey">
                <Link to='/' className="">
                    ...
                    <div className="fr f4 fw4 black-60 dib"> > </div>
                </Link>
            </div>
            ...
            <div className="flex items-center justify-center flex-column mt3">
                <div className="w-60 tc pt1 pb1 br4 bg-washed-red f6 ttc">{completedStatus ? completedStatus : matchSchedule.toss ? matchSchedule.toss : matchSchedule.matchStatus}</div>
            </div>
        </div>
    );
}
